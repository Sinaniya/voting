...
contract Voting {
    ...
    function castVote_Hospital(uint _vote_hospital, uint _weight_hospital) public {
    ...
    function average() public returns (uint) {
        ...
        avg = ((total_doner_Sum / total_doner_Votes ) * (total_doner_weight_Sum / total_doner_Votes) + (total_hospital_Sum / total_hospital_Votes) * (total_hospital_weight_Sum / total_hospital_Votes)) / ((total_doner_weight_Sum / total_doner_Votes) + (total_hospital_weight_Sum / total_hospital_Votes));
